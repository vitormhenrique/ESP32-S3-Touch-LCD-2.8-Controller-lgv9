...
lv_obj_t *ui_NavSwitchIndicators[2][5] = {{NULL}}; // [NavIndex][Direction]
...
static lv_obj_t* create_gimbal_widget(lv_obj_t *parent, lv_obj_t **dot_out)
{
...
//=============================================================================
// Create Nav Switch Widget
//=============================================================================

static lv_obj_t* create_nav_switch_widget(lv_obj_t *parent, uint8_t index)
{
    ...
    for (int i = 0; i < 5; i++) {
        ...
        ui_NavSwitchIndicators[index][i] = ind;
    }
...
static void create_input_screen(void)
{
    ...
    ui_GimbalLeft = create_gimbal_widget(ui_GimbalPage, &ui_GimbalLeftDot);
    ui_GimbalRight = create_gimbal_widget(ui_GimbalPage, &ui_GimbalRightDot);
    ...
    create_nav_switch_widget(ui_NavPage, 0);
    create_nav_switch_widget(ui_NavPage, 1);
...
void ui_set_nav_switch(uint8_t index, bool up, bool down, bool left, bool right, bool center)
{
    ...
    for (int i = 0; i < 5; i++) {
        lv_obj_t *ind = ui_NavSwitchIndicators[index][i];
        if (ind) {
